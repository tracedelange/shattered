...
export const GRAMMAR_DIR = join(WORLD_DIR, 'grammar');
export const FACTIONS_FILE = join(GRAMMAR_DIR, 'factions.yaml');
export const ARCHETYPES_FILE = join(GRAMMAR_DIR, 'archetypes.yaml');
